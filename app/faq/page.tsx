...
const faqs = [
  ...
  ["Is there a file size limit?", "User-facing limits are duration based: Free 60 minutes per file, Pro 180, Studio 360. Automatic transcription also has a 1 GiB technical file-size limit today."],

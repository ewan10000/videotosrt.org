...
const faqs = [
  ...
  ["Is there a file size limit?", `User-facing limits are duration based: Free 60 minutes per file, Pro 180, Studio 360. Automatic transcription supports source files up to ${TECHNICAL_TRANSCRIPTION_UPLOAD_LABEL} today.`],

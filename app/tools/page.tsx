        ...
        <header className="border-b border-soft/15 py-[72px]">
          <div className="site-container">
            ...
            <p className="mb-0 max-w-[760px] text-lg leading-[1.7] text-muted">
              These tools reflect current product abilities only: local media upload, AI transcription with Google sign-in, inline editing, and SRT, VTT, or TXT export. Automatic transcription supports source files up to {TECHNICAL_TRANSCRIPTION_UPLOAD_LABEL} in addition to minute quotas.
            </p>
          </div>
        </header>
